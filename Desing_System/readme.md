...
| `02. Connexion` | — |
| `03. Tableau de bord` | `03.1` direction retenue · `03.2` aperçu « à traiter » |
...
| `06. Attribuer et restituer` | `06.1` parcours complet · `06.2` la preuve · `06.3` fins de flux · `06.4` demander un équipement · `06.5` détail et arbitrage d'une demande |
| `07. Mon compte` | — |
| `08. Tâches` | `08.1` boîte de travail unique |
...
| --- | --- |
| `08.1` Tâches | **boîte de travail de référence** — une unique entrée pour *À faire*, *À suivre* et *Historique* ; tri par ancienneté, filtres par nature, état vide. Les détails et gestes d'une demande vivent en `06.5`, jamais dans une seconde file. |
