...
| `CORRESPONDANCE-ICONES.md` | Les ~80 icônes du code vers Phosphor, par rôle. Deux tailles d'emploi, un seul cas de `fill`. |
...
reprendre les correspondances : **`CORRESPONDANCE-ICONES.md` donne les ~80 noms relevés, groupés par
rôle**, les six paires à fusionner, les trois triplets à ne pas fusionner, et le conflit `tune` contre
`Funnel` à arbitrer. Le registre fixe deux tailles d'emploi (18 et 20 px en rangée) et la
