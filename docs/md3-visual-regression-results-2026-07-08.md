...
| Compact (iPhone 14 Pro) | Dashboard | `/dashboard` | updated | `docs/md3-visual-baseline/compact/dashboard.png` | `docs/md3-visual-current/2026-07-08/compact/dashboard.png` |
| Compact (iPhone 14 Pro) | Approvals | `/approvals` | updated | `docs/md3-visual-baseline/compact/approvals.png` | `docs/md3-visual-current/2026-07-08/compact/approvals.png` |
...
| Compact (iPhone 14 Pro) | Reports | `/reports` | updated | `docs/md3-visual-baseline/compact/reports.png` | `docs/md3-visual-current/2026-07-08/compact/reports.png` |
| Compact (iPhone 14 Pro) | Settings | `/settings` | updated | `docs/md3-visual-baseline/compact/settings.png` | `docs/md3-visual-current/2026-07-08/compact/settings.png` |
...
| Compact (iPhone 14 Pro) | User details | `/users/1` | updated | `docs/md3-visual-baseline/compact/user_details.png` | `docs/md3-visual-current/2026-07-08/compact/user_details.png` |
| Compact (iPhone 14 Pro) | Audit details | `/audit/details` | updated | `docs/md3-visual-baseline/compact/audit_details.png` | `docs/md3-visual-current/2026-07-08/compact/audit_details.png` |
...
| Medium (iPad Mini) | Dashboard | `/dashboard` | updated | `docs/md3-visual-baseline/medium/dashboard.png` | `docs/md3-visual-current/2026-07-08/medium/dashboard.png` |
| Medium (iPad Mini) | Approvals | `/approvals` | updated | `docs/md3-visual-baseline/medium/approvals.png` | `docs/md3-visual-current/2026-07-08/medium/approvals.png` |
...
| Medium (iPad Mini) | Reports | `/reports` | updated | `docs/md3-visual-baseline/medium/reports.png` | `docs/md3-visual-current/2026-07-08/medium/reports.png` |
| Medium (iPad Mini) | Settings | `/settings` | updated | `docs/md3-visual-baseline/medium/settings.png` | `docs/md3-visual-current/2026-07-08/medium/settings.png` |
...
| Expanded (Desktop 1440p) | Dashboard | `/dashboard` | match | `docs/md3-visual-baseline/expanded/dashboard.png` | - |
| Expanded (Desktop 1440p) | Approvals | `/approvals` | updated | `docs/md3-visual-baseline/expanded/approvals.png` | `docs/md3-visual-current/2026-07-08/expanded/approvals.png` |
...
| Expanded (Desktop 1440p) | Reports | `/reports` | updated | `docs/md3-visual-baseline/expanded/reports.png` | `docs/md3-visual-current/2026-07-08/expanded/reports.png` |
