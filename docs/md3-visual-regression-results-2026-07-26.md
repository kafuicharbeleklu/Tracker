...
- Baseline created: 0
- Baseline updated: 0
- Changed (regressions): 6
- Pass: 33
- Fail: 6

| Device | Checkpoint | Route | Status | Baseline | Current |
| --- | --- | --- | --- | --- | --- |
| Compact (iPhone 14 Pro) | Login | `/` | changed | `docs/md3-visual-baseline/compact/login.png` | `docs/md3-visual-current/2026-07-26/compact/login.png` |
| Compact (iPhone 14 Pro) | Dashboard | `/dashboard` | changed | `docs/md3-visual-baseline/compact/dashboard.png` | `docs/md3-visual-current/2026-07-26/compact/dashboard.png` |
...
| Medium (iPad Mini) | Login | `/` | changed | `docs/md3-visual-baseline/medium/login.png` | `docs/md3-visual-current/2026-07-26/medium/login.png` |
| Medium (iPad Mini) | Dashboard | `/dashboard` | changed | `docs/md3-visual-baseline/medium/dashboard.png` | `docs/md3-visual-current/2026-07-26/medium/dashboard.png` |
...
| Expanded (Desktop 1440p) | Login | `/` | changed | `docs/md3-visual-baseline/expanded/login.png` | `docs/md3-visual-current/2026-07-26/expanded/login.png` |
| Expanded (Desktop 1440p) | Dashboard | `/dashboard` | changed | `docs/md3-visual-baseline/expanded/dashboard.png` | `docs/md3-visual-current/2026-07-26/expanded/dashboard.png` |
