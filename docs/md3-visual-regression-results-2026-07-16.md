...
| Compact (iPhone 14 Pro) | Approvals | `/approvals` | updated | `docs/md3-visual-baseline/compact/approvals.png` | `docs/md3-visual-current/2026-07-16/compact/approvals.png` |
| Compact (iPhone 14 Pro) | Locations | `/locations` | match | `docs/md3-visual-baseline/compact/locations.png` | - |
| Compact (iPhone 14 Pro) | Management catalog | `/management` | updated | `docs/md3-visual-baseline/compact/management.png` | `docs/md3-visual-current/2026-07-16/compact/management.png` |
...
| Compact (iPhone 14 Pro) | Audit details | `/audit/details` | updated | `docs/md3-visual-baseline/compact/audit_details.png` | `docs/md3-visual-current/2026-07-16/compact/audit_details.png` |
...
| Medium (iPad Mini) | Management catalog | `/management` | updated | `docs/md3-visual-baseline/medium/management.png` | `docs/md3-visual-current/2026-07-16/medium/management.png` |
...
| Medium (iPad Mini) | Audit details | `/audit/details` | updated | `docs/md3-visual-baseline/medium/audit_details.png` | `docs/md3-visual-current/2026-07-16/medium/audit_details.png` |
