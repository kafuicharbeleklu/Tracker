...
| --- | --- | --- | --- | --- | --- |
| Compact (iPhone 14 Pro) | Login | `/` | updated | `docs/md3-visual-baseline/compact/login.png` | `docs/md3-visual-current/2026-07-16/compact/login.png` |
| Compact (iPhone 14 Pro) | Dashboard | `/dashboard` | match | `docs/md3-visual-baseline/compact/dashboard.png` | - |
...
| Compact (iPhone 14 Pro) | Reports | `/reports` | updated | `docs/md3-visual-baseline/compact/reports.png` | `docs/md3-visual-current/2026-07-16/compact/reports.png` |
| Compact (iPhone 14 Pro) | Settings | `/settings` | match | `docs/md3-visual-baseline/compact/settings.png` | - |
| Compact (iPhone 14 Pro) | Assignment wizard | `/wizards/assignment` | updated | `docs/md3-visual-baseline/compact/assignment_wizard.png` | `docs/md3-visual-current/2026-07-16/compact/assignment_wizard.png` |
| Compact (iPhone 14 Pro) | Return wizard | `/wizards/return` | match | `docs/md3-visual-baseline/compact/return_wizard.png` | - |
| Compact (iPhone 14 Pro) | Add equipment | `/inventory/add` | updated | `docs/md3-visual-baseline/compact/add_equipment.png` | `docs/md3-visual-current/2026-07-16/compact/add_equipment.png` |
...
| Medium (iPad Mini) | Login | `/` | updated | `docs/md3-visual-baseline/medium/login.png` | `docs/md3-visual-current/2026-07-16/medium/login.png` |
| Medium (iPad Mini) | Dashboard | `/dashboard` | updated | `docs/md3-visual-baseline/medium/dashboard.png` | `docs/md3-visual-current/2026-07-16/medium/dashboard.png` |
...
| Medium (iPad Mini) | Reports | `/reports` | updated | `docs/md3-visual-baseline/medium/reports.png` | `docs/md3-visual-current/2026-07-16/medium/reports.png` |
| Medium (iPad Mini) | Settings | `/settings` | match | `docs/md3-visual-baseline/medium/settings.png` | - |
| Medium (iPad Mini) | Assignment wizard | `/wizards/assignment` | updated | `docs/md3-visual-baseline/medium/assignment_wizard.png` | `docs/md3-visual-current/2026-07-16/medium/assignment_wizard.png` |
| Medium (iPad Mini) | Return wizard | `/wizards/return` | match | `docs/md3-visual-baseline/medium/return_wizard.png` | - |
| Medium (iPad Mini) | Add equipment | `/inventory/add` | updated | `docs/md3-visual-baseline/medium/add_equipment.png` | `docs/md3-visual-current/2026-07-16/medium/add_equipment.png` |
...
| Expanded (Desktop 1440p) | Login | `/` | updated | `docs/md3-visual-baseline/expanded/login.png` | `docs/md3-visual-current/2026-07-16/expanded/login.png` |
| Expanded (Desktop 1440p) | Dashboard | `/dashboard` | updated | `docs/md3-visual-baseline/expanded/dashboard.png` | `docs/md3-visual-current/2026-07-16/expanded/dashboard.png` |
...
| Expanded (Desktop 1440p) | Reports | `/reports` | updated | `docs/md3-visual-baseline/expanded/reports.png` | `docs/md3-visual-current/2026-07-16/expanded/reports.png` |
| Expanded (Desktop 1440p) | Settings | `/settings` | match | `docs/md3-visual-baseline/expanded/settings.png` | - |
| Expanded (Desktop 1440p) | Assignment wizard | `/wizards/assignment` | updated | `docs/md3-visual-baseline/expanded/assignment_wizard.png` | `docs/md3-visual-current/2026-07-16/expanded/assignment_wizard.png` |
| Expanded (Desktop 1440p) | Return wizard | `/wizards/return` | match | `docs/md3-visual-baseline/expanded/return_wizard.png` | - |
| Expanded (Desktop 1440p) | Add equipment | `/inventory/add` | updated | `docs/md3-visual-baseline/expanded/add_equipment.png` | `docs/md3-visual-current/2026-07-16/expanded/add_equipment.png` |
