...
| Compact (iPhone 14 Pro) | Locations | `/locations` | updated | `docs/md3-visual-baseline/compact/locations.png` | `docs/md3-visual-current/2026-07-09/compact/locations.png` |
...
| Compact (iPhone 14 Pro) | Add equipment | `/inventory/add` | updated | `docs/md3-visual-baseline/compact/add_equipment.png` | `docs/md3-visual-current/2026-07-09/compact/add_equipment.png` |
...
| Medium (iPad Mini) | Dashboard | `/dashboard` | match | `docs/md3-visual-baseline/medium/dashboard.png` | - |
| Medium (iPad Mini) | Approvals | `/approvals` | match | `docs/md3-visual-baseline/medium/approvals.png` | - |
| Medium (iPad Mini) | Locations | `/locations` | updated | `docs/md3-visual-baseline/medium/locations.png` | `docs/md3-visual-current/2026-07-09/medium/locations.png` |
...
| Medium (iPad Mini) | Finance | `/finance` | updated | `docs/md3-visual-baseline/medium/finance.png` | `docs/md3-visual-current/2026-07-09/medium/finance.png` |
...
| Expanded (Desktop 1440p) | Locations | `/locations` | updated | `docs/md3-visual-baseline/expanded/locations.png` | `docs/md3-visual-current/2026-07-09/expanded/locations.png` |
...
| Expanded (Desktop 1440p) | Finance | `/finance` | updated | `docs/md3-visual-baseline/expanded/finance.png` | `docs/md3-visual-current/2026-07-09/expanded/finance.png` |
