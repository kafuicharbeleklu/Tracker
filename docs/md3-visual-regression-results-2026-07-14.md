...
| Compact (iPhone 14 Pro) | Reports | `/reports` | changed | `docs/md3-visual-baseline/compact/reports.png` | `docs/md3-visual-current/2026-07-14/compact/reports.png` |
| Compact (iPhone 14 Pro) | Settings | `/settings` | match | `docs/md3-visual-baseline/compact/settings.png` | - |
| Compact (iPhone 14 Pro) | Assignment wizard | `/wizards/assignment` | changed | `docs/md3-visual-baseline/compact/assignment_wizard.png` | `docs/md3-visual-current/2026-07-14/compact/assignment_wizard.png` |
...
| Medium (iPad Mini) | Dashboard | `/dashboard` | changed | `docs/md3-visual-baseline/medium/dashboard.png` | `docs/md3-visual-current/2026-07-14/medium/dashboard.png` |
...
| Medium (iPad Mini) | Reports | `/reports` | changed | `docs/md3-visual-baseline/medium/reports.png` | `docs/md3-visual-current/2026-07-14/medium/reports.png` |
| Medium (iPad Mini) | Settings | `/settings` | match | `docs/md3-visual-baseline/medium/settings.png` | - |
| Medium (iPad Mini) | Assignment wizard | `/wizards/assignment` | changed | `docs/md3-visual-baseline/medium/assignment_wizard.png` | `docs/md3-visual-current/2026-07-14/medium/assignment_wizard.png` |
| Medium (iPad Mini) | Return wizard | `/wizards/return` | match | `docs/md3-visual-baseline/medium/return_wizard.png` | - |
| Medium (iPad Mini) | Add equipment | `/inventory/add` | changed | `docs/md3-visual-baseline/medium/add_equipment.png` | `docs/md3-visual-current/2026-07-14/medium/add_equipment.png` |
...
| Expanded (Desktop 1440p) | Dashboard | `/dashboard` | changed | `docs/md3-visual-baseline/expanded/dashboard.png` | `docs/md3-visual-current/2026-07-14/expanded/dashboard.png` |
...
| Expanded (Desktop 1440p) | Reports | `/reports` | changed | `docs/md3-visual-baseline/expanded/reports.png` | `docs/md3-visual-current/2026-07-14/expanded/reports.png` |
| Expanded (Desktop 1440p) | Settings | `/settings` | match | `docs/md3-visual-baseline/expanded/settings.png` | - |
| Expanded (Desktop 1440p) | Assignment wizard | `/wizards/assignment` | changed | `docs/md3-visual-baseline/expanded/assignment_wizard.png` | `docs/md3-visual-current/2026-07-14/expanded/assignment_wizard.png` |
